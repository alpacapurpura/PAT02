...
Overview
- Syncs manuals and category effective documents to RAG
- Indexes entry/exit checklists per equipment category
- Provides AI conversations via odoo_bot focused on active maintenance orders
