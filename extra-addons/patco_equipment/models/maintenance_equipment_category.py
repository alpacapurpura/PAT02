...
class MaintenanceEquipmentCategory(models.Model):
    ...
    def _compute_effective_checklists(self):
        for record in self:
            record.x_effective_entry_checklist = record.x_entry_checklist_template or (record.parent_id.x_effective_entry_checklist if record.x_inherit_checklists and record.parent_id else False)
            record.x_effective_exit_checklist = record.x_exit_checklist_template or (record.parent_id.x_effective_exit_checklist if record.x_inherit_checklists and record.parent_id else False)
